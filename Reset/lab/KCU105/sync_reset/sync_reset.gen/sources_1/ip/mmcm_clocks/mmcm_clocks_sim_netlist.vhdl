...
-- Date        : Sun Nov 27 10:54:03 2022
-- Host        : amd running 64-bit Ubuntu 20.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/amd/training/Reset/lab/KCU105/sync_reset/sync_reset.gen/sources_1/ip/mmcm_clocks/mmcm_clocks_sim_netlist.vhdl
-- Design      : mmcm_clocks
...
end mmcm_clocks_clk_wiz;

architecture STRUCTURE of mmcm_clocks_clk_wiz is
...
entity mmcm_clocks is
  ...
  attribute NotValidForBitStream of mmcm_clocks : entity is true;
end mmcm_clocks;

architecture STRUCTURE of mmcm_clocks is
begin
inst: entity work.mmcm_clocks_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
