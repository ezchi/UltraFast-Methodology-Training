...
-- Date        : Sun Nov 27 10:54:02 2022
-- Host        : amd running 64-bit Ubuntu 20.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ mmcm_clocks_sim_netlist.vhdl
-- Design      : mmcm_clocks
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mmcm_clocks_clk_wiz is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mmcm_clocks_clk_wiz;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mmcm_clocks_clk_wiz is
  signal clk_in1_mmcm_clocks : STD_LOGIC;
  signal clk_out1_mmcm_clocks : STD_LOGIC;
  signal clk_out2_mmcm_clocks : STD_LOGIC;
  signal clkfbout_buf_mmcm_clocks : STD_LOGIC;
  signal clkfbout_mmcm_clocks : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE"
        ...
        port map (
      CE => '1',
      I => clkfbout_mmcm_clocks,
      O => clkfbout_buf_mmcm_clocks
    );
...
begin
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mmcm_clocks_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
