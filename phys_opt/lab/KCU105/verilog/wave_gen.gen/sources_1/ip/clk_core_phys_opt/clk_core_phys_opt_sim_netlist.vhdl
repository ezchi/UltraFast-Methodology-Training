...
--               /home/amd/training/phys_opt/lab/KCU105/verilog/wave_gen.gen/sources_1/ip/clk_core_phys_opt/clk_core_phys_opt_sim_netlist.vhdl
...
entity clk_core_phys_opt_clk_wiz is
  port (
...
end clk_core_phys_opt_clk_wiz;

architecture STRUCTURE of clk_core_phys_opt_clk_wiz is
  signal clk_in1_clk_core_phys_opt : STD_LOGIC;
  signal clk_out1_clk_core_phys_opt : STD_LOGIC;
  signal clk_out2_clk_core_phys_opt : STD_LOGIC;
  signal clkfbout_buf_clk_core_phys_opt : STD_LOGIC;
  signal clkfbout_clk_core_phys_opt : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE"
        ...
        port map (
      CE => '1',
      I => clkfbout_clk_core_phys_opt,
      O => clkfbout_buf_clk_core_phys_opt
    );
...
entity clk_core_phys_opt is
  ...
  attribute NotValidForBitStream of clk_core_phys_opt : entity is true;
end clk_core_phys_opt;

architecture STRUCTURE of clk_core_phys_opt is
begin
inst: entity work.clk_core_phys_opt_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1,
